...
const { pending } = useFormStatus(); // need to be used one level deeper so we create a separate component for the button.
  ...
  return (
    ...
    hover:bg-gray-950 disabled:scale-110 disabled:bg-opacity-65'
    disabled={pending}>
        {
