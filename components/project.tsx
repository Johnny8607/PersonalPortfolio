...
export default function Project({
    ...
    return (
        ...
        className="mb-3 sm:mb-8 last:mb-0">
            <section className='group bg-gray-100 max-w-[48rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] 
            even:pl-3 hover:bg-gray-200 transition rounded-lg dark:bg-white/10 dark:hover:bg-white/20 dark:text-white'>
                ...
                className='absolute hidden sm:block top-[4.2rem] -right-40 w-[36.5rem] rounded-t-lg shadow-2xl 
                transition 
