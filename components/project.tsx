...
export default function Project({
    ...
    return (
        ...
        className="mb-3 sm:mb-8 last:mb-0">
            <section className='group bg-gray-100 max-w-[48rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] even:pl-3 hover:bg-gray-200 transition rounded-lg'>
                ...
                className='absolute top-[4.2rem] -right-40 w-[36.5rem] rounded-t-lg shadow-2xl 
                transition 
